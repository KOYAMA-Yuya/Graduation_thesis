...
\title{
  \centering
    ...
    \scalebox{1.0}{オフラインで模倣する手法の提案}\\
    \scalebox{0.8}{(複数カメラでデータセットを収集しオフラインで訓練する手法の検証)}
    ...
    \scalebox{0.7}{(Offline training with automatically collected multi-camera datasets)}
    \vspace{-7.0zh}
}
