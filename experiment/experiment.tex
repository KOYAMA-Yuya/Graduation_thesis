...
\begin{figure}[h]
  \centering
  \includegraphics[keepaspectratio, scale=0.5]{images/exp1_loss.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[keepaspectratio, scale=0.5]{images/exp2_loss.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[keepaspectratio, scale=0.5]{images/old-method_analysis.png}
...
\newpage
\section{実験3}
実験2では平行に±0.20m離した上, 更に±5度の画像, 計9台のカメラを使用しているが, 
実環境を考えると現実的ではないため, ±５度の画像は射影変換によって疑似的に再現する. 
